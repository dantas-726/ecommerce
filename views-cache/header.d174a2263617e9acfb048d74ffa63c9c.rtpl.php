  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/categories"><i class="/admin/categories"></i> <span>Categorias</span></a></li>
        <li><a href="/admin/products"><i class="/admin/categories"></i> <span>Produtos</span></a></li>
        <li class="treeview">
